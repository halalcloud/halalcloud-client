 ...
 */
#ifndef BAIDU_BOS_CPPSDK_BOS_RESPONSE_GET_OBJECT_ACL_RESPONSE_H
#define BAIDU_BOS_CPPSDK_BOS_RESPONSE_GET_OBJECT_ACL_RESPONSE_H
...
class GetObjectAclResponse : public JsonResponse {
public:
    GetObjectAclResponse() {}
    virtual ~GetObjectAclResponse() {}
