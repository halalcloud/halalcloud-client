# Halal Cloud Client Versioning

This document applies to all versions of Halal Cloud Client.
...
The build number is the number of days since January 16, 2024 because the 
first version of Halal Cloud Client is created and published on that day.
